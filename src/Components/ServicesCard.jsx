            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-4 service-content"> {/* Increased p-2 to p-4 */}
                  ...
                  <motion.p
                    className="text-sm text-center opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 px-2" // Added px-2 for text breathing room
                  >
                    {service.description}
                  </motion.p>
                </div>
